      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.default = {
          ...
          current: function current(type, value) {
            ...
            var data = self.data[type];
            // var arrTimeData = null;

            // if (self.element && self.element.defaultValue) {
            //   arrTimeData = self.element.defaultValue.split(":");
            // }
            ...
            switch (token.charAt(0)) {
              ...
              case "H":
                // if (arrTimeData && arrTimeData.length > 0) {
                //   value = parseInt(arrTimeData[0]);
                // }
                // if ($.isNumber(value)) {
                //   console.log(value);
                // } else {
              ...
              case "m":
                ...
                // if (arrTimeData && arrTimeData.length > 1) {
                //   value = parseInt(arrTimeData[1]);
                // }
                // if ($.isNumber(value)) {
                //   // date.setMinutes(value);
                //   currentMinutest = value;
                // } else {
                //   currentMinutest = date.getMinutes();
                // }
              ...
              case "V":
                // if (arrTimeData && arrTimeData.length > 2) {
                //   value = parseInt(arrTimeData[2]);
                // }
                // if ($.isNumber(value)) {
